...
export default function UserMaster() {
  ...
  return (
    <main className="flex-1 overflow-y-auto p-6">
      <div className="bg-white shadow rounded-lg mb-6">
        <div className='md:flex justify-between items-center bg-card-header px-6 py-6 mb-6 rounded-t-lg'>
          ...
          <div className="flex space-x-2 max-md:mt-3">
            ...
            <button className="px-8 py-2 bg-button text-white rounded-lg hover:bg-header" onClick={handleFormSubmit}>Save</button>
          </div>
        </div>
      ...
      {/* Permissions */}
      <div className="bg-white shadow rounded-lg mb-6">
        <div className='flex justify-between items-center bg-card-header px-6 py-6 mb-6 rounded-t-lg'>
