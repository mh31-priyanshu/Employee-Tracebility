  ...
  return (
    <main className="flex-1 overflow-y-auto p-6">
      ...
      <div className="bg-white shadow rounded-lg">
        <div className='flex justify-between items-center bg-[#F7F9FC] px-6 py-6 mb-6 rounded-t-lg'>
            <h3 className="text-lg font-semibold">Line Assignment Table:</h3>
            <div className="flex justify-end  space-x-2">
          ...
          <table className="min-w-full">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="px-4 py-2 text-left">Employee Barcode</th>
            ...
            <tbody>
              {[
                ...
                <tr key={line.id} className="border-b">
                  ...
                  <td className="px-4 py-2">{line.shift}</td>
                  <td className="px-4 py-2">{line.lineName}</td>
                  <td className="px-4 py-2">{line.employeeName}</td>
                  <td className="px-4 py-2">{line.employeeBarcode}</td>
